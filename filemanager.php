...
$max_upload_size_bytes = 500000000; 
            ...
            <div class="container h-100">
                <div class="row justify-content-md-center align-content-center h-100vh">
                    <div class="card-wrapper">
                        <div class="card fat" data-bs-theme="<?php echo FM_THEME; ?>" style="background-color: #333;">
                            <div class="card-body">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p>
                        <h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> File Manager <?php echo VERSION; ?></a></h3>
                        </p>
                ...
                <div class="btn-toolbar" role="toolbar">
                    <?php if (!$isNormalEditor) { ?>
                        <div class="btn-group js-ace-toolbar">
                            <button data-cmd="none" data-option="fullscreen" class="btn btn-sm btn-custom" style="margin-left: 3px; border-radius: 5px;" id="js-ace-fullscreen" title="<?php echo lng('Fullscreen') ?>"><i class="fa fa-expand" title="<?php echo lng('Fullscreen') ?>"></i></button>
                            <button data-cmd="find" class="btn btn-sm btn-custom" style="margin-left: 4px; border-radius: 5px;" id="js-ace-search" title="<?php echo lng('Search') ?>"><i class="fa fa-search" title="<?php echo lng('Search') ?>"></i></button>
                            <button data-cmd="undo" class="btn btn-sm btn-custom" style="margin-left: 4px; border-radius: 5px;" id="js-ace-undo" title="<?php echo lng('Undo') ?>"><i class="fa fa-undo" title="<?php echo lng('Undo') ?>"></i></button>
                            <button data-cmd="redo" class="btn btn-sm btn-custom" style="margin-left: 4px; border-radius: 5px;" id="js-ace-redo" title="<?php echo lng('Redo') ?>"><i class="fa fa-repeat" title="<?php echo lng('Redo') ?>"></i></button>
                            <button data-cmd="none" data-option="wrap" class="btn btn-sm btn-custom" style="margin-left: 4px; border-radius: 5px;" id="js-ace-wordWrap" title="<?php echo lng('Word Wrap') ?>"><i class="fa fa-text-width" title="<?php echo lng('Word Wrap') ?>"></i></button>
                            <select id="js-ace-mode" data-type="mode" title="<?php echo lng('Select Document Type') ?>" class="btn-outline-secondary border-start-0 d-none d-md-block form-select" style="margin-left: 4px;">
                                <option>-- <?php echo lng('Select Mode') ?> --</option>
                            </select>
                            <select id="js-ace-fontSize" data-type="fontSize" title="<?php echo lng('Select Font Size') ?>" class="btn-outline-secondary border-start-0 d-none d-lg-block form-select" style="margin-left: 4px;">
        ...
        <div class="card mb-2" data-bs-theme="<?php echo FM_THEME; ?>">
            ...
            <div class="card-body">
                ...
                <form action="" method="post">
                    ...
                    <table class="table" style="background-color: #222 !important; color: #fff !important; border-radius: 10px;">
                        <tr>
                            <td></td>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="table-responsive">
        <table class="table table-hover table-sm" id="main-table" style="background-color: #222 !important; color: #fff !important; border-radius: 10px;">
            <thead class="thead-white" style="background-color: #222 !important; color: #fff !important; border-radius: 10px;">
                <tr style="background-color: #222 !important; color: #fff !important; border-radius: 10px;">
                    <?php if (!FM_READONLY): ?>
                ...
                <tfoot>
                    <tr>
                        <td class="gray fs-7" colspan="<?php echo (!FM_IS_WIN && !$hide_Cols) ? (FM_READONLY ? '6' : '7') : (FM_READONLY ? '4' : '5') ?>">
                            <?php echo lng('FullSize') . ': <span class="badge border-radius-0">' . fm_get_filesize($all_files_size) . '</span>' ?>
                            <?php echo lng('File') . ': <span class="badge border-radius-0">' . $num_files . '</span>' ?>
                            <?php echo lng('Folder') . ': <span class="badge border-radius-0">' . $num_folders . '</span>' ?>
                        </td>
                    </tr>
                </tfoot>
            <?php } ?>
...
?>
    <nav class="navbar navbar-expand-lg mb-4 main-nav <?php echo $isStickyNavBar ?>" data-bs-theme="<?php echo FM_THEME; ?>" style="background-color: #333;">
                ...
                <ul class="navbar-nav justify-content-end" data-bs-theme="<?php echo FM_THEME; ?>">
                    <li class="nav-item mr-2">
                        <div class="input-group input-group-sm mr-1" style="margin-top:4px;">
                            ...
                            <div class="input-group-append btn-group">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" style="background-color: #333; padding: 5px;">
                                    <a class="btn btn-custom" style="font-size: 14px; width: 100%;" href="<?php echo $path2 = $path ? $path : '.'; ?>" id="js-search-modal" data-bs-toggle="modal" data-bs-target="#searchModal"><?php echo lng('Advanced Search') ?></a>
                                </div>
                            </div>
                        </div>
                    </li>
                    ...
                    <?php if (FM_USE_AUTH): ?>
                        <li class="nav-item avatar dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end text-small shadow" style="background-color: #333; padding: 5px;" aria-labelledby="navbarDropdownMenuLink-5" data-bs-theme="<?php echo FM_THEME; ?>">
                                <?php if (!FM_READONLY): ?>
                                    <a title="<?php echo lng('Settings') ?>" class="btn btn-custom" style="width: 100%; margin-bottom: 4px;" href="?p=<?php echo urlencode(FM_PATH) ?>&amp;settings=1"><i class="fa fa-cog" aria-hidden="true"></i> <?php echo lng('Settings') ?></a>
                                <?php endif ?>
                                <a title="<?php echo lng('Logout') ?>" class="btn btn-custom" style="width: 100%;" href="?logout=1"><i class="fa fa-sign-out" aria-hidden="true"></i> <?php echo lng('Logout') ?></a>
                            </div>
                        </li>
                    <?php else: ?>
                        <?php if (!FM_READONLY): ?>
                            <li class="nav-item">
                                <a title="<?php echo lng('Settings') ?>" class="nav-link" style="width: 100%; margin-left: 4px;" href="?p=<?php echo urlencode(FM_PATH) ?>&amp;settings=1"><i class="fa fa-cog" aria-hidden="true"></i> <?php echo lng('Settings') ?></a>
...
border-color: #222;
    ...
    <body class="fm-login-page <?php echo (FM_THEME == "dark") ? 'theme-dark' : ''; ?>" style="background-color: background-color: #222;">
...
?>
    ...
    <head>
        ...
        <title><?php echo fm_enc(APP_TITLE) ?> | <?php echo (isset($_GET['view']) ? $_GET['view'] : ((isset($_GET['edit'])) ? $_GET['edit'] : "File Manager")); ?></title>
        <?php print_external('pre-jsdelivr'); ?>
    ...
    function fm_show_footer()
    {
        ...
        ?>
            ...
            <script>
                ...
                editor.setTheme("ace/theme/chaos"); // Dark Theme
                ...
                function renderThemeMode() {
                    ...
                    if (_data && _data.aceTheme) {
                        var lightTheme = optionNode("ace/theme/", _data.aceTheme.light),
